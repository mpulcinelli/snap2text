...
bool DrawingArea::on_motion_notify_event(GdkEventMotion *motion_event)
{
...
bool DrawingArea::on_focus(Gtk::DirectionType direction)
{
    return true;
}

void DrawingArea::take_screen_shot()
{
...
void DrawingArea::get_text_from_screen_shot()
{
